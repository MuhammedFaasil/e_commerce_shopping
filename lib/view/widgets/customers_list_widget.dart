...
import 'package:e_commerce_app/view/widgets/customer_view_widget.dart';
        ...
        return InkWell(
          onTap: () => showDialog(
            ...
            builder: (context) => AlertDialog(
              content: ViewCustomer(model: entity[index]),
            ),
          ),
          child: Container(
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                        image:
                            AssetImage('asset/images/Max-R_Headshot (1).jpg')),
                  ),
                ),
                const SizedBox(
                  width: 16,
